...
public class FoodItems {
    ...
    public static final Item PUMPKIN_SLICE = new Item(new Item.Settings()

            //Decides in which Item Group it will be added to, in this case FOOD tab
    ...
    public static final Item HONEY_COOKIE = new Item(new Item.Settings()
            .group(ItemGroup.FOOD)
            .maxCount(64)
            .food(new FoodComponent.Builder()
    ...
    public static final Item SWEET_BERRY_COOKIE = new Item(new Item.Settings()
            .group(ItemGroup.FOOD)
            .maxCount(16)
            .food(new FoodComponent.Builder()
                    .saturationModifier(0.6F)
    ...
    public static final Item SWEET_BERRY_PIE = new Item(new Item.Settings()
            .group(ItemGroup.FOOD)
            .maxCount(64)
            .food(new FoodComponent.Builder()
                    .saturationModifier(12.8F)
    ...
    public static final Item PUMPKIN_SOUP = new MushroomStewItem(new Item.Settings()
            .group(ItemGroup.FOOD)
            .maxCount(1)
            .food(new FoodComponent.Builder()
