...
public class FoodBlocks extends Block{
    ...
    public static void foodBlocksRegistry() {
        ...
        Registry.register(Registry.ITEM, new Identifier(Vafoen.MOD_ID, "chocolate_cake"), new BlockItem(CHOCOLATE_CAKE, new Item.Settings().group(ItemGroup.FOOD).maxCount(1)));
    }
}
